  ...
  return (
    ...
    {showAuthModal && (
      <div
        role="dialog"
        aria-modal="true"
        aria-label="Log in to upload your resume"
        className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 overflow-y-auto"
      >
        <div className="bg-[var(--color-bg)] rounded-xl p-6 max-w-sm w-full mx-4 border-2 border-[var(--color-border)] shadow-2xl">
          ...
          <div className="flex flex-col gap-3">
            <Link
              href="/login?callbackUrl=/interview"
              className="w-full text-center px-4 py-2.5 rounded-lg bg-[var(--color-accent)] text-[var(--color-bg)] font-semibold font-[family-name:var(--font-body)] hover:bg-[var(--color-accent-hover)] transition-colors"
            >
              Log In
            </Link>
            <Link
              href="/signup?callbackUrl=/interview"
              className="w-full text-center px-4 py-2.5 rounded-lg border-2 border-[var(--color-border)] text-[var(--color-fg)] font-semibold font-[family-name:var(--font-body)] hover:bg-[var(--color-bg-alt)] transition-colors"
            >
              Sign Up Free
            </Link>
            <button
