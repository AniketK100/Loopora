/**
 * Get User Favorites API Route
 *
 * GET /api/profile/favorites?page=1&limit=20 — Retrieve paginated favorite questions for user
 *
 * @route /api/profile/favorites
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Slice bookmarks array for in-memory pagination
    ...
    // Order questions matches based on bookmarks index ordering
    ...
    // Re-sort questions matching bookmarks array order
    ...
    console.error("[Favorites GET API] Error fetching user favorites:", error);
    return NextResponse.json(
